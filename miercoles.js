...
function generate3(id, dia, horastart, horaend, minstart, minstop){
  //LUNES//
if (dia == "miercoles") {
...
añadir3( gentd, horastart, horaend, minstart, minstop,dia);
}}
  //LUNES//
var sumatotales = 0;
function añadir3(obj,hstart, hstop, mstart, mstop,dia1){
...
document.getElementById('valormier').innerHTML = " Miercoles" + sumatotales ;
}
